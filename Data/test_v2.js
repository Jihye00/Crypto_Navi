...
const KSLP_ADDRESS = {
  ...
  // ABL_KORC_ADDRESS: "0xa2867c345f9b7250fe6be6cccb6360dff9f6e38c"
  KETH_KORC_ADDRESS: "0x9e1cd9645eb2753d4d4a94786bb76cc99adb689b"
};
const DEFINIXLP_ADDRESS = {
  ...
  KWBTC_KLAY_ADDRESS: "0x84cd5b54daa59e7ae5a9d45f630ce690292fc4c1"
};
const TOKEN_ADDRESS = {
...
async function test() {
  for(i=0; i<type.MATRIX_SIZE; i++){
    ...
    klayswap_data.push(row1);
    definix_data.push(row2);
  }
